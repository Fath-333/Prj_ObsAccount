...
public class CategoryTC {
  ...
  public void add_category(String categoryName,String categoryCode ) throws IOException, InterruptedException {
		...
		String exp_message=POMCategory.expected_message;
  ...
  {
	  boolean status=objpomCategory.Search_category(PropertyFileRead.readConfigFile("categorySearch"));
	  SoftAssert asser=new SoftAssert();
  ...
  {
	  objpomCategory.delete_category(PropertyFileRead.readConfigFile("categorySearch"));
  ...
  categoryData[0][0]="Category_fathima";
  // Enter data to row 0 column 1
  categoryData[0][1]="Category_f";
