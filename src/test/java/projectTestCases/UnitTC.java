...
public class UnitTC extends ExtendTestManager {
	...
	public void Add_units(String unitData1,String unittData2) throws InterruptedException, IOException {
		...
		objPomUnits.addUnits(unitData1,unittData2);
	...
	{
		boolean status=objPomUnits.searchUnits(PropertyFileRead.readConfigFile("unitSearch"));
		SoftAssert asser=new SoftAssert();
	...
	{
		objPomUnits.delete_unit(PropertyFileRead.readConfigFile("unitSearch"));
	...
	public void afterTest() {
	 ...
	 @DataProvider(name="testdata")
	  ...
	  unitsData[0][0]="Unit_fathima";
	  // Enter data to row 0 column 1
	  unitsData[0][1]="Unit_tF";
