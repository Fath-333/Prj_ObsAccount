...
public class BrandTC {
  ...
  public void addBrands(String brandName,String brandDescription) throws IOException, InterruptedException {
		...
		String current_message=POMBrands.expected_message;
  ...
  {
	 boolean status=objPomBrands.search_brand(PropertyFileRead.readConfigFile("brandSearch"));
	 SoftAssert asser=new SoftAssert();
  ...
  brandData[0][0]="Brand_fathima";
  // Enter data to row 0 column 1
  brandData[0][1]="Brand_F";
